...
namespace MiHoYoTools.Modules.Zenless.Views.NotifyViews
{
    public sealed partial class BannerView : Page
    {
        ...
        private readonly string imageFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "JSG-LLC", "ZenlessTools", "images", "banners");
