...
using MiHoYoTools.Modules.Zenless.Views.NotifyViews;
using System.IO;
...
namespace MiHoYoTools.Modules.Zenless.Views
{
    public sealed partial class MainView : Page
    {
        ...
        private string imageFolderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "JSG-LLC", "ZenlessTools", "images");
        private string imageLinksFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "JSG-LLC", "ZenlessTools", "images", "imagelinks.json");
