...
using System.IO;
using static MiHoYoTools.Modules.Zenless.Depend.GachaModel;
...
namespace MiHoYoTools.Modules.Zenless.Depend
{
    public class GachaRecords
    {
        ...
        {
            string recordsPath = AppPaths.ResolveGameFolder(GameType.ZenlessZoneZero, "GachaRecords");
            ...
            string filePath = Path.Combine(recordsPath, $"{uid}.json");
            ...
            GachaRepository.SyncFromZenless(existingData);
