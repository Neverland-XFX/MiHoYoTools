...
namespace MiHoYoTools.Depend
{
    public class MainFrameController
    {
        ...
        public void Navigate(string tag)
        {
            ...
            {
                case "home":
                    mainFrame.Navigate(typeof(HomeHostView));
                    break;
                case "game_select":
                    mainFrame.Navigate(typeof(GameSelectView));
                    break;
                case "startgame":
                    mainFrame.Navigate(typeof(StartGameHostView));
                    break;
                case "gacha":
                    mainFrame.Navigate(typeof(GachaHostView));
                    break;
                case "donation":
                    ...
                    break;
                case "settings":
                    mainFrame.Navigate(typeof(SettingsHostView));
                    break;
                default:
