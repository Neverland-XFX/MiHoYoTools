...
using static MiHoYoTools.Depend.GachaModel;
...
namespace MiHoYoTools.Depend
{
    public class GachaRecords
    {
        ...
        {
            string recordsPath = AppPaths.ResolveGameFolder(GameType.StarRail, "GachaRecords");
            ...
            GachaRepository.SyncFromStarRail(existingData);
