...
{
    public sealed partial class SettingsHostView : Page
    {
        ...
        private void LoadGameView(GameType game)
        {
            ...
            {
                HostFrame.Navigate(typeof(AboutView));
            }
            else
            {
                HostFrame.Navigate(typeof(MiHoYoTools.Modules.Zenless.Views.AboutView));
            }
        }
