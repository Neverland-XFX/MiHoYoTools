...
{
    public sealed partial class StartGameHostView : Page
    {
        public StartGameHostView()
        {
            InitializeComponent();
        ...
        private void LoadGameView(GameType game)
        {
            ...
            {
                HostFrame.Navigate(typeof(StartGameView));
            }
            else
            {
                HostFrame.Navigate(typeof(MiHoYoTools.Modules.Zenless.Views.StartGameView));
            }
        }
